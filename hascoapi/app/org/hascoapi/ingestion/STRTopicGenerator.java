...
public class STRTopicGenerator extends BaseGenerator {
    ...
    public void initMapping() {
        mapCol.clear();
        mapCol.put("StreamURI", templates.getMESSAGESTREAMURI());
        mapCol.put("TopicName", templates.getTOPICNAME());
        mapCol.put("DeploymentUri", templates.getDEPLOYMENTURI());
        mapCol.put("CellScope", templates.getCELLSCOPE());
    }
